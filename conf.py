...
_C.VICTIM.PATHIN = '/home/ankita/scratch/msacopy/ckpts/cifar10-resnet32/checkpoint.pth.tar'

# Image size
_C.VICTIM.IMG_SIZE = 224

# LInear probed or fft victim
_C.VICTIM.LP = True
...
# Thief model image input size 
_C.THIEF.IMG_SIZE = 224
...
# Load already selected labeled and val set?
_C.THIEF.LOAD_LABELED_SET = False
_C.THIEF.LABELED_SET_PATH = None
_C.THIEF.VAL_SET_PATH = None

# LInear probed or fft thief
_C.THIEF.LP = True
...
# Output directory
_C.OUT_DIR = "/home/deepankar_v/scratch/MSA/model_stealing_encoders/MSA_results"
...
# Architecture
_C.CLIP.model = 'ViT-B/32'

# Device
_C.CLIP.device = "cuda" if torch.cuda.is_available() else "cpu"

# Cache dir
_C.CLIP.cache_dir = None

# Template
_C.CLIP.template = None

# Train dataset
_C.CLIP.train_dataset = None

# Data location
_C.CLIP.data_location = None

# Batch size
_C.CLIP.batch_size = _C.TRAIN.BATCH

# Classnames
_C.CLIP.classnames = None
